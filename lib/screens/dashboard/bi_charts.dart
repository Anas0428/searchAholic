...
class _BiChartsState extends State<BiCharts> {
  ...
  Future<List<Salesdata>> getData() async {
    var email = await FlutterApi().getEmail();
    var storeId = FlutterApi().generateStoreId(email);
  ...
  Future<void> getHotProduct() async {
    var storeId2 = FlutterApi().generateStoreId(await FlutterApi().getEmail());
    var stores = await Firestore.instance.collection(storeId2).get();
    Map productCounter2 = {};
